...
void createServer(GtkWidget *widget, gpointer data)
{
  g_print("Create server\n");
  prep();
}
...
int main(int argc, char *argv[])
{
  ...
  button=gtk_button_new_with_label("Create server");
  g_signal_connect_swapped(G_OBJECT(button),"clicked",G_CALLBACK(createServer),NULL);
